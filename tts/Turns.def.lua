...
---@field skip_empty_hands boolean @Skips a player's turn if there are no object in the player's (primary) hand. WARNING: Does not presently work when using a custom turn ordering.
